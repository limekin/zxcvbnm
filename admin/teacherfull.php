...
<?php
$query="select login.id as l,username,im_users.name as nam,dob,image,gender,address,email,mobile,course.name as cou from login,im_users,course,im_teacher where login.id=im_users.login_id and login.id=im_teacher.loginid and course.id=im_teacher.courseid and login_id='$id'";
$s=mysql_query($query);
                    ...
                    <div class="agileinfo_banner_bottom_right1">
                        ...
                        <div class="agileinfo_banner_bottom_right1_grid">
                            <table class='table table-bordered text-center'border="1" align="center">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <a href="view_teacher.php"class="glyphicon glyphicon-backward">back</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
